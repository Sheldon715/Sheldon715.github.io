...
const translations = {
  zh: {
    "nav.menu": "菜单", "nav.work": "作品", "nav.profile": "简介", "nav.experience": "经历", "nav.education": "教育", "nav.contact": "联系", "nav.resume": "简历",
    ...
    "work.kicker": "02 / 精选作品", "work.title": "作为系统构建，<br />不止于屏幕。", "work.intro": "每个项目都记录界面背后的判断：产品范围、系统架构、数据边界、评测与交付。", "work.index": "项目索引",
    ...
    "profile.kicker": "03 / 个人简介", "profile.title": "产品思维，<br />工程深度。", "profile.lede": "我是 Sheldon Liu，就读于墨尔本大学计算机科学专业。我喜欢负责从产品需求到可运行、可测试版本的完整路径。", "profile.body": "我的工作覆盖界面设计、API、数据建模、检索、AI 集成、测试与部署。我尤其关注有事实依据的 AI 系统：语言模型帮助理解与解释，而可靠的应用数据控制事实和业务操作。",
    ...
    "experience.kicker": "01 / 实习经历", "experience.title": "把产品想法，<br />变成可用系统。", "experience.intro": "在真实产品环境中，把产品思维、移动端界面与 AI 基础设施连成一条完整路径。", "experience.status": "当前参与", "experience.location": "墨尔本 / 远程", "experience.company": "Ground Zero", "experience.role": "全栈开发实习生 · Flutter / AI 产品方向", "experience.product": "GroundzeroApp · 创意社交平台", "experience.lede": "参与 GroundzeroApp 创意社交平台的全栈开发，连接 Flutter/Dart 产品界面、内容流程、用户发现与 Astro AI 后端，把交互、状态、权限和数据流放进同一套可维护的产品系统。", "experience.currentLabel": "当前参与", "experience.current": "负责对话界面、消息状态、输入与附件、本地会话持久化，以及基于 Supabase、PostgreSQL/RLS 与 Edge Functions 的服务边界。", "experience.futureLabel": "后续方向", "experience.future": "围绕 onboarding 引导、内容建议、用户发现和岗位生成建设 Skills 化能力，并让它们从真实产品反馈中持续迭代，而不是停留在孤立演示。", "experience.feedbackLabel": "反馈闭环", "experience.feedback": "下一步建立围绕建议采纳、拒绝、完成、响应质量、延迟、成本和错误率的可用评估闭环，让 AI 能力的改进有真实证据支撑。",
    "capabilities.kicker": "04 / 能力结构", "capabilities.title": "相互连接的工程工具箱。", "capabilities.intro": "这些能力不是孤立关键词，而是共同服务于产品路径：从界面与服务，到数据、AI、测试和交付。", "capabilities.ai": "AI 与 RAG", "capabilities.web": "Web 工程", "capabilities.mobile": "移动端", "capabilities.data": "数据与云", "capabilities.product": "产品工程",
    ...
    "education.kicker": "05 / 教育经历", "education.title": "在墨尔本学习计算机科学。", "education.university": "墨尔本大学", "education.degree": "计算机科学理学学士", "education.meta": "2023 年 3 月至 2026 年 11 月 · 澳大利亚墨尔本", "education.courseworkLabel": "核心课程", "education.coursework": "算法与数据结构、软件建模、数据库系统、人工智能基础与 Web 计算",
    "contact.kicker": "06 / 联系", "contact.title": "一起构建真正有用的软件。", "contact.body": "我正在寻找墨尔本的软件工程机会，方向包括全栈 Web、AI 驱动产品与 Android 开发。", "contact.email": "发起沟通", "footer.note": "在墨尔本使用 HTML、CSS 与 JavaScript 构建。"
  }
};
...
if ("IntersectionObserver" in window) {
  ...
  ["projects", "about", "experience", "education", "contact"].forEach((id) => {
